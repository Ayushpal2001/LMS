...
const SearchResult = ({ course }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center border-b b border-gray-300 py-4 gap-4 ">
      <Link
      ...
      >
        ...
        src={course.courseThumbnail}
          alt="course-thumbnail" className="h-32 w-full md:w-56 object-cover rounded"
        />
